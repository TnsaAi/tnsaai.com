        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mb-24">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Web search and information retrieval system
            </p>
          </div>

          {/* Getting Started */}
          <div className="text-center bg-gray-50 rounded-2xl p-12">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 mb-6">Start Searching</h2>
