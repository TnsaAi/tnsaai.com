    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="bg-white p-1 h-screen flex items-center justify-center">
        <div
          ...
          style={{
            backgroundImage: 'url(/ground-brown-bg.png)',
        ...
        >
          <div className="relative z-10 mx-auto max-w-4xl px-6 text-center text-white">
            ...
            <p className="text-xl mb-12 leading-relaxed max-w-2xl mx-auto">
              Basic text-to-speech for simple applications.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6 rounded-2xl bg-gray-50">
                ...
                <h3 className="text-xl font-semibold mb-3">Basic TTS</h3>
                <p className="text-gray-600">A simple and straightforward text-to-speech solution.</p>
              </div>
              <div className="text-center p-6 rounded-2xl bg-gray-50">
                ...
                <p className="text-gray-600">Quickly convert text to speech for time-sensitive applications.</p>
              </div>
              <div className="text-center p-6 rounded-2xl bg-gray-50">
                ...
                <p className="text-gray-600">An affordable text-to-speech solution for basic needs.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-24">
            ...
            <div className="bg-orange-50 rounded-2xl p-8 max-w-2xl mx-auto text-center">
              <h3 className="text-xl font-semibold mb-4">AudioTextSpeech-1</h3>
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li>• Basic text-to-speech conversion</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="p-6 border border-gray-200 rounded-xl">
                <h3 className="text-lg font-semibold mb-3">Notifications and Alerts</h3>
                <p className="text-gray-600">Provide audible notifications and alerts in your applications.</p>
              </div>
              <div className="p-6 border border-gray-200 rounded-xl">
                <h3 className="text-lg font-semibold mb-3">Simple IVR Systems</h3>
                <p className="text-gray-600">Create basic interactive voice response (IVR) systems.</p>
              </div>
              <div className="p-6 border border-gray-200 rounded-xl">
                <h3 className="text-lg font-semibold mb-3">Reading out Short Texts</h3>
                <p className="text-gray-600">Quickly convert short pieces of text into speech.</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center bg-gray-50 rounded-2xl p-12">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Get started with AudioTextSpeech-1 for your basic text-to-speech needs.
            </p>
