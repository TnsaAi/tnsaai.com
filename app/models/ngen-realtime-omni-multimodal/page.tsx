        ...
        >
          <div className="relative z-10 mx-auto max-w-4xl px-6 text-center text-white">
            ...
            <p className="text-xl mb-12 leading-relaxed max-w-2xl mx-auto">
              Text, audio, and image in real-time.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6 rounded-2xl bg-gray-50">
                ...
                <p className="text-gray-600">Process text, audio, and image inputs in real-time for instantaneous interactions.</p>
              </div>
              <div className="text-center p-6 rounded-2xl bg-gray-50">
                ...
                <h3 className="text-xl font-semibold mb-3">Text, Audio, Image</h3>
                <p className="text-gray-600">A true omni-modal assistant that understands and processes a variety of inputs.</p>
              </div>
              <div className="text-center p-6 rounded-2xl bg-gray-50">
                ...
                <p className="text-gray-600">Engineered for low-latency responses, making it ideal for real-time communication.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-24">
            ...
            <div className="bg-orange-50 rounded-2xl p-8 max-w-2xl mx-auto text-center">
              <h3 className="text-xl font-semibold mb-4">NGen-Realtime-Omni Multimodal</h3>
              <div className="grid grid-cols-2 gap-8 mb-6">
                ...
                <div>
                  <div className="text-3xl font-bold text-orange-600">₹1.66</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                    ...
                    <li>• Real-time multimodal assistant</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="p-6 border border-gray-200 rounded-xl">
                <h3 className="text-lg font-semibold mb-3">Live Transcription & Analysis</h3>
                <p className="text-gray-600">Transcribe and analyze audio and video streams in real-time.</p>
              </div>
              <div className="p-6 border border-gray-200 rounded-xl">
                <h3 className="text-lg font-semibold mb-3">Interactive Voice Agents</h3>
                <p className="text-gray-600">Create responsive and intelligent voice-activated assistants.</p>
              </div>
              <div className="p-6 border border-gray-200 rounded-xl">
                <h3 className="text-lg font-semibold mb-3">Real-time Video Analysis</h3>
                <p className="text-gray-600">Analyze video feeds in real-time for object detection, scene understanding, and more.</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center bg-gray-50 rounded-2xl p-12">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Build the next generation of real-time multimodal applications with NGen-Realtime-Omni Multimodal.
            </p>
