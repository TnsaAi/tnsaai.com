...
export default function NGen3_15MEmbedPage() {
  return (
        ...
        >
          <div className="relative z-10 mx-auto max-w-4xl px-6 text-center text-white">
            ...
            <p className="text-xl mb-12 leading-relaxed max-w-2xl mx-auto">
              Specialized embedding model for vector representations, semantic search, and similarity matching applications.
            </p>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 max-w-3xl mx-auto">
              <div className="text-center">
                <h3 className="text-2xl font-semibold mb-4">Balanced</h3>
                <p className="text-lg opacity-90">Optimal balance between speed and embedding quality</p>
              </div>
              <div className="text-center">
                <h3 className="text-2xl font-semibold mb-4">Logical</h3>
                <p className="text-lg opacity-90">Semantic understanding for meaningful representations</p>
              </div>
              <div className="text-center">
                <h3 className="text-2xl font-semibold mb-4">Versatile</h3>
                <p className="text-lg opacity-90">Adaptable to various embedding and search tasks</p>
              </div>
            </div>
