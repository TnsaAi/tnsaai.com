        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="mb-16">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              NGen 3.5 Pro delivers professional-grade conversational AI with strong contextual and logical
              understanding. Optimized for enterprise applications requiring high performance at efficient cost.
            </p>
          </div>
