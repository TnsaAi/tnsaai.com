    ...
    <div className="bg-white min-h-screen" style={{ paddingTop: '186px' }}>
      <div className="mx-auto max-w-4xl px-6">
        <div className="text-center">
          ...
          <h1 className="text-4xl font-normal text-black" style={{ marginTop: '0px', marginBottom: '72px' }}>NGen 3.9 Lite 2006 Preview</h1>
        </div>

        <div className="relative w-full max-w-[1028px] mx-auto mb-16 aspect-[1028/560]">
          <Image
            src="https://raw.githubusercontent.com/TnsaAi/images-urls/refs/heads/main/vincent-maufay-MWj1zsf5yjM-unsplash.jpg"
            alt="NGen 3.9 Lite 2006 Preview"
            fill
            priority
        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="mb-16">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              NGen 3.9 Lite 2006 Preview offers early access to the latest experimental features and optimizations, perfect for developers who want to test cutting-edge AI capabilities.
            </p>
          </div>
              ...
              <table className="w-full text-sm border-collapse text-gray-900">
                <thead>
                  <tr className="border-b border-gray-300">
                    ...
                    <th className="text-right py-3 px-2 font-semibold">NGen 3.9 Lite 2006</th>
          ...
          <div className="mb-16">
            ...
            <ul className="list-disc list-inside text-base text-gray-700 leading-relaxed space-y-2">
              ...
              <li>Latest performance optimizations</li>
          ...
          <div className="mb-16">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              ₹0.08 input / ₹0.10 output per 1K tokens
            </p>
          </div>
