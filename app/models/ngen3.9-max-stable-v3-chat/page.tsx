    ...
    <div className="bg-white min-h-screen" style={{ paddingTop: '186px' }}>
      <div className="mx-auto max-w-4xl px-6">
        <div className="text-center">
          ...
          <h1 className="text-4xl font-normal text-black" style={{ marginTop: '0px', marginBottom: '72px' }}>NGen 3.9 Max</h1>
        </div>
        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="mb-16">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              NGen 3.9 Max Stable V3 is the enterprise-grade stable version optimized for production workloads, delivering maximum reliability and performance for mission-critical applications.
            </p>
          </div>
              ...
              <table className="w-full text-sm border-collapse text-gray-900">
                <thead>
                  <tr className="border-b border-gray-300">
                    ...
                    <th className="text-right py-3 px-2 font-semibold">NGen 3.9 Max</th>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm border-collapse text-gray-900">
                ...
                <tbody>
                  <tr className="border-b border-gray-200">
                    <td className="py-3 px-2">NGEN 3.9 MAX V3</td>
                    <td className="text-right py-3 px-2">10,400</td>
                    <td className="text-right py-3 px-2">78.15</td>
                    <td className="text-right py-3 px-2">0.75</td>
                  </tr>
                </tbody>
              </table>
            </div>
