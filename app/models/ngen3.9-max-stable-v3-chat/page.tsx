        ...
        >
          <div className="relative z-10 mx-auto max-w-4xl px-6 text-center text-white">
            <h1 className="text-5xl font-medium tracking-tight mb-8 font-sans sm:text-6xl lg:text-7xl xl:text-8xl">
              NGen3.9-Max-Stable-v3 Chat
            </h1>
            <p className="text-xl mb-12 leading-relaxed max-w-2xl mx-auto">
              Stable enterprise version for production workloads.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6 rounded-2xl bg-gray-50">
                ...
                <h3 className="text-xl font-semibold mb-3">Enterprise-Grade Stability</h3>
                <p className="text-gray-600">Built for mission-critical applications with the highest level of stability and reliability.</p>
              </div>
              <div className="text-center p-6 rounded-2xl bg-gray-50">
                ...
                <p className="text-gray-600">Optimized for production environments, ensuring seamless integration and performance.</p>
              </div>
              <div className="text-center p-6 rounded-2xl bg-gray-50">
                ...
                <h3 className="text-xl font-semibold mb-3">Maximum Reliability</h3>
                <p className="text-gray-600">Engineered for maximum uptime and consistent performance in demanding scenarios.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-24">
            ...
            <div className="bg-orange-50 rounded-2xl p-8 max-w-2xl mx-auto text-center">
              <h3 className="text-xl font-semibold mb-4">NGen3.9-Max-Stable-v3 Chat</h3>
              <div className="grid grid-cols-2 gap-8 mb-6">
                <div>
                  <div className="text-3xl font-bold text-orange-600">₹0.83</div>
                  <div className="text-sm text-gray-600">Input / 1K tokens</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-orange-600">₹1.25</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                    ...
                    <li>• Max Generation: 64K tokens</li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                    ...
                    <li>• Stable enterprise version</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="p-6 border border-gray-200 rounded-xl">
                ...
                <p className="text-gray-600">Power your enterprise-level applications with a stable and reliable AI model.</p>
              </div>
              <div className="p-6 border border-gray-200 rounded-xl">
                <h3 className="text-lg font-semibold mb-3">Production Workloads</h3>
                <p className="text-gray-600">Handle high-volume, production-level workloads with confidence.</p>
              </div>
              <div className="p-6 border border-gray-200 rounded-xl">
                <h3 className="text-lg font-semibold mb-3">Mission-Critical Systems</h3>
                <p className="text-gray-600">Integrate into mission-critical systems where reliability is paramount.</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center bg-gray-50 rounded-2xl p-12">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Deploy NGen3.9-Max-Stable-v3 Chat for your most demanding enterprise applications.
            </p>
