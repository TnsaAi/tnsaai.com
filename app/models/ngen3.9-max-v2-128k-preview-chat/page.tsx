        ...
        >
          <div className="relative z-10 mx-auto max-w-4xl px-6 text-center text-white">
            <h1 className="text-5xl font-medium tracking-tight mb-8 font-sans sm:text-6xl lg:text-7xl xl:text-8xl">
              NGen3.9-Max-v2-128K-Preview Chat
            </h1>
            <p className="text-xl mb-12 leading-relaxed max-w-2xl mx-auto">
              Handles long documents and books.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6 rounded-2xl bg-gray-50">
                ...
                <h3 className="text-xl font-semibold mb-3">Long Document Processing</h3>
                <p className="text-gray-600">Process and analyze long documents, reports, and books with ease.</p>
              </div>
              <div className="text-center p-6 rounded-2xl bg-gray-50">
                ...
                <h3 className="text-xl font-semibold mb-3">Book-Length Context</h3>
                <p className="text-gray-600">Maintain context over extremely long texts, equivalent to the length of a book.</p>
              </div>
              <div className="text-center p-6 rounded-2xl bg-gray-50">
                ...
                <p className="text-gray-600">Perform complex reasoning tasks on large volumes of text.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-24">
            ...
            <div className="bg-orange-50 rounded-2xl p-8 max-w-2xl mx-auto text-center">
              <h3 className="text-xl font-semibold mb-4">NGen3.9-Max-v2-128K-Preview Chat</h3>
              <div className="grid grid-cols-2 gap-8 mb-6">
                <div>
                  <div className="text-3xl font-bold text-orange-600">₹0.66</div>
                  <div className="text-sm text-gray-600">Input / 1K tokens</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-orange-600">₹1.00</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                    ...
                    <li>• Maximum context length model</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="p-6 border border-gray-200 rounded-xl">
                ...
                <p className="text-gray-600">Analyze and extract insights from long-form documents, legal contracts, and research papers.</p>
              </div>
              <div className="p-6 border border-gray-200 rounded-xl">
                <h3 className="text-lg font-semibold mb-3">Book Summarization</h3>
                <p className="text-gray-600">Summarize entire books or long reports into concise summaries.</p>
              </div>
              <div className="p-6 border border-gray-200 rounded-xl">
                <h3 className="text-lg font-semibold mb-3">Knowledge Extraction</h3>
                <p className="text-gray-600">Extract structured information from large unstructured text sources.</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center bg-gray-50 rounded-2xl p-12">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Unlock the power of long-context understanding with NGen3.9-Max-v2-128K-Preview Chat.
            </p>
