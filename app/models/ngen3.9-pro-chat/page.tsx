        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="mb-16">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              NGen 3.9 Pro delivers strong contextual and logical understanding with advanced reasoning capabilities
              for complex problem-solving and conversational AI applications.
            </p>
          </div>
