        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="mb-16">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              NGen 3.9 Pro delivers strong contextual and logical understanding with advanced reasoning capabilities for complex problem-solving and conversational AI applications.
            </p>
          </div>
          ...
          <div className="mb-16">
            ...
            <ul className="list-disc list-inside text-base text-gray-700 leading-relaxed space-y-2">
              <li>Strong contextual and logical understanding</li>
              <li>Advanced reasoning for complex problem-solving</li>
              <li>256K token context length with 32K max generation</li>
              <li>Multilingual support with strong performance</li>
            </ul>
          </div>
