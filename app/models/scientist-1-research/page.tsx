...
export default function Scientist1Page() {
  return (
        ...
        >
          <div className="relative z-10 mx-auto max-w-4xl px-6 text-center text-white">
            ...
            <p className="text-xl mb-12 leading-relaxed max-w-2xl mx-auto">
              Specialized for scientific research and analysis.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6 rounded-2xl bg-gray-50">
                ...
                <h3 className="text-xl font-semibold mb-3">Scientific Reasoning</h3>
                <p className="text-gray-600">Perform complex reasoning tasks in a scientific context.</p>
              </div>
              <div className="text-center p-6 rounded-2xl bg-gray-50">
                ...
                <p className="text-gray-600">Analyze and interpret scientific research papers and data.</p>
              </div>
              <div className="text-center p-6 rounded-2xl bg-gray-50">
                ...
                <h3 className="text-xl font-semibold mb-3">Data Interpretation</h3>
                <p className="text-gray-600">Interpret complex datasets and draw meaningful conclusions.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-24">
            ...
            <div className="bg-orange-50 rounded-2xl p-8 max-w-2xl mx-auto text-center">
              <h3 className="text-xl font-semibold mb-4">Scientist-1</h3>
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li>• Scientific reasoning and analysis assistant</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="p-6 border border-gray-200 rounded-xl">
                ...
                <p className="text-gray-600">Accelerate your scientific research with a powerful AI assistant.</p>
              </div>
              <div className="p-6 border border-gray-200 rounded-xl">
                <h3 className="text-lg font-semibold mb-3">Data Analysis</h3>
                <p className="text-gray-600">Analyze and interpret complex scientific data with ease.</p>
              </div>
              <div className="p-6 border border-gray-200 rounded-xl">
                <h3 className="text-lg font-semibold mb-3">Literature Review</h3>
                <p className="text-gray-600">Quickly review and synthesize scientific literature.</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center bg-gray-50 rounded-2xl p-12">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Empower your scientific research with Scientist-1.
            </p>
